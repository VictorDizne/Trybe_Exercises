...
// function nameAndAge() {
//   let newObject = books.map((book) => ({
//     age: book.releaseYear - book.author.birthYear,
//     author: book.author.name}));
//   newObject.sort((ageA, ageB) => ageA.age - ageB.age);
//   return newObject;
// }
...
//   let oldBooks = books.filter((book)=> (2021 - book.releaseYear>= 60));
...
// function oldBooks() {
//   let oldBooks = books.filter((book) => (2021 - book.releaseYear >= 60));
//   return oldBooks.map((oldBook) => oldBook.name);
// }
